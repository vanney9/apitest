...
function axis(orient, scale) {
  ...
  function axis(context) {
    ...
    //
    tmp.text[x] = k * spacing;
    tmp.text["dy"] = text.attr("dy");
    ...
    axisPath.domain = path.attr("d");

    tick
        .attr("opacity", 1)
        .attr("transform", function(d, i) {
          var trans = transform(position(d));
          axisPath.ticks[i] = {
            tickTrans: trans,
            tick: tmp
          };
    ...
    text
        ...
        .text(function (d, i) {
          var txt = format(d);
          axisPath.ticks[i].tick.text.text = txt;
          return txt;
        });
